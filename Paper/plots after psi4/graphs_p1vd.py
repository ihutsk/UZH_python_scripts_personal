...
el = pd.read_excel('combined_pair_1vd_2a.xlsx')
...
plt.annotate('E$_{\itcoul}$', (7.5, -45.70), xytext=(7.3, -25), ha='center', arrowprops=arrowprops,
...
plt.savefig('pair1_vd_with_pc.svg', dpi=600, format='svg', bbox_inches='tight')
